...
public class teste {
    ...
    private static void listStudents() {
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                reader.close();
                JOptionPane.showMessageDialog(null, "Erro ao buscar alunos! Código de resposta: " + responseCode + ", Resposta: " + response.toString(), "Erro", JOptionPane.ERROR_MESSAGE);
    ...
    private static void createTestimonial() {
        ...
        try {
            ...
            // Correção da formatação JSON
            String jsonInputString = String.format("{\"imageUrl\": \"%s\", \"description\": \"%s\", \"ra\": \"%s\"}", 
                                                   imageUrl, description, ra);
